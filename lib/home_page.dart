import 'package:depi_graduation_project/home_controller.dart';
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    buildCardFilttring(3, 'Restaurants',IconData: Icons.restaurant_sharp),
                  ],
                ),
              )
            ],
        ...
        child: Padding(
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                    IconData!=null?Row(children: [Icon(IconData,color: isSelected ?Colors.white:Colors.black,),SizedBox(width: 10,)],):SizedBox.shrink(),
                   Text(label,
      ...
      decoration: InputDecoration(
        prefixIcon: IconButton(onPressed: () {
          //search code
            ...
            icon: Icon(Icons.search, color: Colors.deepOrangeAccent.shade200,
              size: 27,)),
